...
resource "aws_launch_template" "yolo5-template" {
  name_prefix   = "mohmmad-yolo5-template"
  ...
  user_data = base64encode(templatefile("./modules/yolo5/userdata.sh", {
